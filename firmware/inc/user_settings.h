...
extern int generate_trng_block(unsigned char* output, unsigned int sz);
#undef  CUSTOM_RAND_GENERATE
#define CUSTOM_RAND_GENERATE  generate_trng_block
#define CUSTOM_RAND_GENERATE_SEED  generate_trng_block
...
/* Choose RNG method */
    ...
    #define CUSTOM_RAND_GENERATE_BLOCK  generate_trng_block
#endif
